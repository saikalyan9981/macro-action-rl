...
bool Agent::doMarkPlayer(int unum) {
  ...
  // double dist_to_post1 = goal_pos1.dist2(kicker_pos);
  // double dist_to_post2 = goal_pos2.dist2(kicker_pos);
  ...
  // Do reduce goal angle but wrt to player_pos.
  Vector2D ball_pos = player_pos ; 
