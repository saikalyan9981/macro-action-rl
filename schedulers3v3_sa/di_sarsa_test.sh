...
do
    ...
    --port 7160 --no-logging --headless --deterministic --trials 200 --seed 1 > logs/di_sarsa.log 2>&1 &

    PID=$!
    cd di_sarsa
    sleep 5

    ./di_sarsa --numAgents 1 --numOpponents 3 --numEpisodes 0 --numEpisodesTest 200 --basePort 7160 \
