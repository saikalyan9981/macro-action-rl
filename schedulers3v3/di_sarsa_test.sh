...
do
	...
	--weightId di_sarsa_lambda_0.5_seed_1_episode_50000 --lambda 0.5 --step 8 --loadFile weights_0_di_sarsa_lambda_0.5_step_32_seed_1_episode_$i --loadFile1 weights_1_di_sarsa_lambda_0.5_step_32_seed_1_episode_$i > ../logs/6_debug.log
